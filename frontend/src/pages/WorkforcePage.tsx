  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-[var(--text-primary)]">Personnel</h2>
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            Daily underground and surface personnel assignments, shift muster rolls, and attendance records.
          </p>
        </div>
