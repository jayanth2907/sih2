...
import { PageLoadingState } from '../components/ui/EmptyState';
...
export const AppLayout: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentTab) {
      ...
      case 'demo-control':        return <DemoControlCenterPage />;
      case 'field-operations':    return <FieldOperationsPage />;
      case 'integrations-health': return <IntegrationsHealthPage />;
      case 'copilot':             return <CopilotPage />;
      case 'predictive-risk':     return <PredictiveRiskPage />;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Header />
        <main
          className="flex-1 p-5 md:p-6 max-w-7xl w-full mx-auto page-enter"
          id="main-content"
          tabIndex={-1}
        >
